...
export function useBotEngine() {
    ...
    const parseNaturalLanguageOrder = (text, lang) => {
        ...
        // English numbers + Arabic numbers pattern + common speech recognition errors
        const numberPattern = "\\d+|one|two|three|four|five|six|seven|eight|nine|ten|single|double|triple|too|to|tree|free|for|fore|ate|won|tu|ton|واحد|واحدة|اثنين|اثنان|ثلاثة|ثلاث|أربعة|اربعة|خمسة|خمس";
