...
const isLikelyCategory = (text) => {
    ...
    const categoryKeywords = ['burger', 'wrap', 'sandwich', 'side', 'meal', 'juice', 'drink'];
...
export function useBotEngine() {
    ...
    const findBestMatchCategory = (text, lang) => {
        ...
        // 1. Exact match (perfect score) - check both languages
        ...
        // Only return if confidence is reasonable (score < 250)
        return (bestMatch && bestScore < 250) ? bestMatch : null;
    };
