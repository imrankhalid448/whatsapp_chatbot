                        ...
                        <div className="mt-3 space-y-2 border-t border-dashed border-gray-200 pt-2">
                            ...
                            {message.options.map(opt => (
                                <button
                                    ...
                                    className="w-full bg-slate-50 border border-transparent rounded-lg text-[#008a71] font-semibold py-2.5 hover:bg-slate-100 transition-all active:scale-95 text-center shadow-sm"
                                >
                                    {opt.label}
                                </button>
                            ))}
