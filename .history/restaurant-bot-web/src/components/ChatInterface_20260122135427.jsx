...
export function ChatInterface() {
    ...
    useEffect(() => {
        if ('webkitSpeechRecognition' in window || 'SpeechRecognition' in window) {
            ...
            // Support both English and Arabic - browser will auto-detect
    ...
    return (
        <div className="relative w-full max-w-md h-[850px] bg-[#efe7dd] shadow-2xl overflow-hidden flex flex-col font-sans border border-gray-300 rounded-3xl">
            ...
            <div className="bg-[#F0F2F5] p-2 flex items-center gap-2 shrink-0">
                ...
                <button
                    onClick={inputObj ? handleSend : handleVoiceInput}
                    className={`w-10 h-10 rounded-full ${isListening ? 'bg-red-500 animate-pulse' : 'bg-[#075E54]'} text-white flex items-center justify-center shadow-sm hover:bg-[#064e46] transition-colors`}
                >
