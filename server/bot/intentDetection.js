...
const detectIntent = (text, lang = 'en') => {
	...
	let generalMenuPatterns = isAr ?
		['عرض القائمة', 'القائمة', 'المنيو', 'منيو', 'قائمة الطعام', 'وش عندكم', 'ايش عندكم', 'ماذا لديكم', 'وريني الاكل', 'ابغى اطلب', 'طلب جديد', 'قائمة الاسعار', 'اصناف الاكل', 'ماهي الاصناف', 'بدي شوف المنيو', 'عرض الاصناف', 'وش تبيعون', 'وريني المنيو', 'وين المنيو', 'شنو عندكم', 'شو عندكم', 'فيه منيو'] :
